  ...
  <div class="master">
    ...
    <div class="main-part">
      <div class="section-list" v-for="master in masters" :key="master.no">
        <rotatePhoto :master="master" v-if="isWidthChange"></rotatePhoto>
...
export default {
  ...
  mounted() {
    ...
    if(this.screenWidth >= 992){
        this.masters[0].svgstyle = "top: 5.6vw; left: 2.2vw; width: 24vw; height: 7vw;";
        this.masters[1].svgstyle = "top: 2.1vw; left: 0.9vw; width: 39vw; height: 26vw;";
        this.masters[2].svgstyle = "top: 2.7vw; left: 9.2vw; width: 30vw; height: 7vw;";
        this.isWidthChange = false;
        this.$nextTick(() => {
          this.isWidthChange = true;
        });
      }   
      else if(this.screenWidth < 992 && this.screenWidth >= 785){
        this.masters[0].svgstyle = "top: 4.4rem; left: 1.1rem; width: 20rem; height: 17.5rem;";
        this.masters[1].svgstyle = "top: 1.8rem; left: 0.2rem; width: 32rem; height: 32rem;";
        this.masters[2].svgstyle = "top: 2rem; left: 6.8rem; width: 25rem; height: 14rem;";
        this.isWidthChange = false;
        this.$nextTick(() => {
          this.isWidthChange = true;
        });
      }   
      else if(this.screenWidth < 785){
        this.masters[0].svgstyle = "top: 3.8rem; left: 1.4rem; width: 15rem; height: 15rem;";
        this.masters[1].svgstyle = "top: 1.7rem; left: 0.7rem; width: 24rem; height: 3rem;";
        this.masters[2].svgstyle = "top: 1.6rem; left: 5.6rem; width: 19rem; height: 1rem;";
        this.isWidthChange = false;
        this.$nextTick(() => {
          this.isWidthChange = true;
        });
...
.section-list:nth-child(1){
  background-image: url("../assets/master/1.png");
  background-repeat: repeat;
  background-color: beige;
  background-blend-mode: multiply;
}
.section-list:nth-child(2){
  background-image: url("../assets/master/2.png");
  background-repeat: repeat;
  background-color: #d3def1;
  background-blend-mode: multiply;
}
.section-list:nth-child(3){
  background-image: url("../assets/master/3.png");
  background-repeat: repeat;
